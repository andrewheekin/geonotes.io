        ...
        <div className="flex flex-row mb-4 mt-2 w-full">
            <Select
                ...
                classNames={{
                    ...
                    multiValueRemove: () => 'text-xl font-mono tracking-tight bg-gray-300 dark:bg-gray-700 px-2 py-0 rounded-2xl hover:bg-gray-400 dark:hover:bg-gray-600 hover:text-gray-800 duration-100',
