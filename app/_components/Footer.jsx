...
export default function Footer() {
  return (
    <footer className="shadow-none container mx-auto flex flex-wrap flex-col md:flex-row items-center justify-between px-4 py-6 md:py-12">
      ...
      <span className="text-black text-sm font-medium pb-4 md:pb-0">©2023 GeoNotes. All rights reserved.</span>

      <div className="flex items-center space-x-12">
        <Link
          href="https://github.com/andrewheekin/geonotes.io"
          className="flex text-black text-md font-medium hover:text-gray-500"
        >
          <GitHubIcon />
          <div className="ml-1">GitHub</div>
        </Link>
        <Link href="/privacy-policy" className="text-black hover:text-gray-500 font-medium">
          Privacy Policy
        </Link>
      </div>
    </footer>
