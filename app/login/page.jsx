  ...
  return (
    <div className="max-w-xl w-full flex justify-center p-8">
      <div className="max-w-md w-full">
        ...
        <p className="text-md text-black dark:text-white font-semibold tracking-tight my-2 py-2">
          Login to GeoNotes.io to submit and comment on GeoNotes.
        </p>
        <AuthForm />
        <p className="text-sm text-black dark:text-white font-medium tracking-tight my-2 py-2">
