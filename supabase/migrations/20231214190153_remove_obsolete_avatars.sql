-- ############################################################
-- ########## define the following SQL functions in the SQL Editor to delete storage objects via the API:
-- ############################################################
...
-- ########## If this step is omitted, you won't be able to delete users without first manually deleting their avatar image.
-- ############################################################
